...
export const mockOrders: Order[] = [
    { id: 'VOLTIX-1234', clientId: 'USR-001', items: [{id: 'p1', name: 'iPhone 15 Pro Max', quantity:1, price: 850000, category: 's', image: '', dataAiHint: '', description: ''}], total: 850000, date: '2024-05-10', status: 'delivered', signature: 'Ali Koné' },
    { id: 'VOLTIX-5678', clientId: 'USR-002', items: [{id: 'p13', name: 'AirPods Pro 2', quantity:1, price: 180000, category: 's', image: '', dataAiHint: '', description: ''}], total: 180000, date: '2024-04-22', status: 'delivered', signature: 'Fatou Cissé' },
    { id: 'VOLTIX-9101', clientId: 'USR-001', items: [{id: 'p7', name: 'MacBook Pro 16" M3', quantity:1, price: 1200000, category: 's', image: '', dataAiHint: '', description: ''}], total: 1200000, date: '2024-02-15', status: 'cancelled', signature: 'Ali Koné' },
    { id: 'VOLTIX-17212497', clientId: 'USR-004', date: '2024-07-17T20:56:12.981Z', total: 850000, status: 'validated', signature: 'Aïcha Traoré', items: [{ id: 'p1', name: 'iPhone 15 Pro Max', category: 'smartphones', price: 850000, image: 'https://placehold.co/600x400', dataAiHint: "iphone pro", description: 'Le smartphone le plus avancé d\'Apple...', quantity: 1}] },
    { id: 'VOLTIX-17212423', clientId: 'USR-004', date: '2024-07-15T18:32:10.111Z', total: 1380000, status: 'delivered', signature: 'Aïcha Traoré', items: [{ id: 'p7', name: 'MacBook Pro 16" M3', category: 'laptops', price: 1200000, image: 'https://placehold.co/600x400', dataAiHint: "macbook pro", description: 'Ordinateur portable professionnel...', quantity: 1}, { id: 'p13', name: 'AirPods Pro 2', category: 'audio', price: 180000, image: 'https://placehold.co/600x400', dataAiHint: "airpods pro", description: 'Écouteurs sans fil...', quantity: 1}] },
];
